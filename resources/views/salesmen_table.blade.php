                    ...
                    <td>
                        <div class="action-menu-container">
                            ...
                            <div class="action-dropdown">
                                <button type="button" onclick="openEditSalesmanModal('{{ $salesman->id }}', '{{ addslashes($salesman->name) }}', '{{ addslashes($salesman->mobile) }}', '{{ addslashes($salesman->email) }}', '{{ $salesman->ref_code }}', '{{ $salesman->status }}', '{{ $salesman->monthly_target }}', '{{ $salesman->city_id }}', '{{ addslashes($salesman->city->city ?? '') }}', '{{ $salesman->profile_image ? asset('uploads/' . $salesman->profile_image) : '' }}')">
